            ...
            <div class="card">
              <div class="card-header bg-transparent">
                <div class="row align-items-center">
                  <div class="col">
                    <h5 class="h3 mb-0">Kategori</h5>
                  </div>
                  <div class="col-e">
                      <a class="btn btn-primary text-white" href="{{ route('admins.add-kategori')}}">Tambah Kategori</a>
                  </div>
                </div>
              </div>
